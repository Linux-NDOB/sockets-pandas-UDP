...
// For better Json data format sending
     ...
     int temperature =  (uint16_t) temp;
      ...
      if(millis() > print_time_elapsed )
      {
        ...
        if(leadoff_deteted == true)
        {
          ...
          //jsonData["Heart Rate"] = 99;
          //jsonData["Resp Rate"] = 110;
          jsonData.add(99);
          jsonData.add(120);
        }
        else
        {
          //jsonData["Heart Rate"] = global_HeartRate;
          jsonData.add(global_HeartRate);
          
          //jsonData["Resp Rate"] = global_RespirationRate;
          jsonData.add(global_RespirationRate);
        ...
        //jsonData["Temperature"] = getTemperature(); 
        jsonData.add(getTemperature());   

        //jsonData.prettyPrintTo(SerialUSB);
        //serializeJson(jsonData, SerialUSB);
        //SerialUSB.println();
        jsonData.printTo(SerialUSB);
        SerialUSB.println();
        delay(1000);
